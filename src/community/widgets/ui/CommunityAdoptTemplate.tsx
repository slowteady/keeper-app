...
import { CommunityAdoptCard, CommunityAdoptCardData } from '@/community/entities';
import { ADOPT_ANIMAL_TYPES, AnimalType } from '@/domains/animal';
import { BottomSheetMenu, ButtonGroup, useBottomSheet } from '@/shared';
import { useLoginRequired } from '@/shared/hooks';
import { ChipButton } from '@/shared/ui/button/ChipButton';
