...
import { COMMUNITY_LIST_FILTER, communityAdoptFilterAtom } from '@/community';
import { AdoptCard, AdoptCardSchema } from '@/community/entities';
import { adoptListValue } from '@/community/entities/model/mock';
