...
const AdoptMenuSection = () => {
  ...
  //             handlePress: () => {
  //               router.dismiss();
  //               setTimeout(() => router.push('/abandonments'), 100);
  //             }
  //           };
  //         }
  //         case 'NEAR_DEADLINE': {
  ...
  //             handlePress: () => {
  //               router.dismiss();
  //               setTimeout(() => router.push({ pathname: '/abandonments', params: { filter: 'NEAR_DEADLINE' } }), 100);
  //             }
  //           };
  //         }
  //         case 'NEW': {
  ...
  //             handlePress: () => {
  //               router.dismiss();
  //               setTimeout(() => router.push({ pathname: '/abandonments', params: { filter: 'NEW' } }), 100);
  //             }
  //           };
  //         }
  //       }
